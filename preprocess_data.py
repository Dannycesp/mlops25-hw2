...
def read_dataframe(filename: str):
    ...
    # Original line for green taxi data: df['duration'] = df['lpep_dropoff_datetime'] - df['lpep_pickup_datetime']
...
# Original line for green taxi data: def run_data_prep(raw_data_path: str, dest_path: str, dataset: str = "green"):
